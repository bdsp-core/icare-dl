...
%             dropoutLayer(0.1)
        ...
        options = trainingOptions('sgdm', ...%adam sgdm
            ...
            'ValidationFrequency',5,... %'ValidationData',{test_data_short,test_label},...
            'Verbose',false);%'OutputFcn', @(info)savetrainingplot(info)
        
        net = trainNetwork(train_data_short,train_label,layers,options);
        [pred,probabilities] = classify(net,test_data_short);
